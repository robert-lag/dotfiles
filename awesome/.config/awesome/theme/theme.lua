...
theme.border_focus_floating = darker(xrdb.color8, -20)
theme.border_normal = darker(xrdb.color8, -10)
theme.border_focus  = darker(xrdb.color8, -55)
...
theme.tasklist_popup_opacity = 0.9
...
theme.tasklist_wifi_low_signal_fg = theme.fg_normal
theme.tasklist_cpu = xrdb.color4
theme.tasklist_ram = xrdb.color4
...
theme.menu_fg_focus = xrdb.color13
