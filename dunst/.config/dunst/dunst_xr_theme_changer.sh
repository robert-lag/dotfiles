#!/usr/bin/env bash
# Source: https://github.com/dunst-project/dunst/blob/master/contrib/dunst_xr_theme_changer.sh
###############################################################################
##
## Usage
##
...
declare -A theme_attr_dict=(
    ...
    ["urgency_low-background"]="\"$(xrdb_get 'color0' '#2b303b')bb\""
    ["urgency_low-foreground"]="\"$(xrdb_get 'color15' '#65737e')\""
    ["urgency_low-frame_color"]="\"$(xrdb_get 'color8' '#65737e')\""
    ["urgency_low-highlight"]="\"$(xrdb_get 'color4' '#3b84c0')\""

    ["urgency_normal-background"]="\"$(xrdb_get 'color0' '#2b303b')bb\""
    ["urgency_normal-foreground"]="\"$(xrdb_get 'color15' '#a3be8c')\""
    ["urgency_normal-frame_color"]="\"$(xrdb_get 'color8' '#a3be8c')\""
    ["urgency_normal-highlight"]="\"$(xrdb_get 'color15' '#abb2bf')\""
